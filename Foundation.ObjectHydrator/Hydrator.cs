...
namespace Foundation.ObjectHydrator
{
    public class Hydrator<T> : IGenerator<T>
    {
        ...
        private void SetPropertyMap<TProperty>(Expression<Func<T, TProperty>> expression,
            IGenerator<TProperty> generator)
        {
        ...
        {
            var propertyName = ((MemberExpression) expression.Body).Member.Name;
            var propertyInfo1 = typeof(T).GetProperty(propertyName,
                BindingFlags.IgnoreCase | BindingFlags.Public | BindingFlags.Instance);
            ...
            if (!propertyInfo1.CanWrite)
                throw new ArgumentException("The Property can not be written.", propertyName);
            var propertyInfo = propertyInfo1;
        ...
        private void Populate(T instance)
        {
            ...
            foreach (var mapping in _propertyMap.Values)
            {
                var propertyInfo = instance.GetType()
                    .GetProperty(mapping.PropertyName, BindingFlags.Public | BindingFlags.Instance);
        ...
        private void AddTypeMapToPropertyMap()
        {
            ...
            foreach (var propertyInfo in _typeOfT.GetProperties())
        ...
        {
            var gen = (IGenerator<TProperty>) new IntegerGenerator(minimum, maximum);
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new GuidGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }

        public Hydrator<T> WithCustomGenerator<TProperty>(Expression<Func<T, TProperty>> expression,
            IGenerator<TProperty> customgenerator)
        {
        ...
        public Hydrator<T> WithDate<TProperty>(Expression<Func<T, TProperty>> expression, DateTime minimum,
            DateTime maximum)
        {
            var gen = (IGenerator<TProperty>) new DateTimeGenerator(minimum, maximum);
            SetPropertyMap(expression, gen);
        ...
        {
            var gen = (IGenerator<TProperty>) new DoubleGenerator(decimalPlaces);
            SetPropertyMap(expression, gen);
            return this;
        }

        public Hydrator<T> WithDouble<TProperty>(Expression<Func<T, TProperty>> expression, double minimum,
            double maximum)
        {
            var gen = (IGenerator<TProperty>) new DoubleGenerator(minimum, maximum);
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        public Hydrator<T> WithDouble<TProperty>(Expression<Func<T, TProperty>> expression, double minimum,
            double maximum, int decimalPlaces)
        {
            var gen = (IGenerator<TProperty>) new DoubleGenerator(minimum, maximum, decimalPlaces);
            SetPropertyMap(expression, gen);
        ...
        {
            var gen = (IGenerator<TProperty>) new EnumGenerator(enumValues);
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        /// <returns>This instance of the Hydrator for type T.</returns>
        public Hydrator<T> WithEnum<TProperty>(Expression<Func<T, TProperty>> expression,
            Func<IEnumGeneratorOptionsBuilder<TProperty>, IEnumGeneratorOptionsBuilder<TProperty>> options = null)
        ...
        {
            var gen = (IGenerator<TProperty>) new ByteArrayGenerator(length);
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new AmericanAddressGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new AmericanCityGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new AmericanPhoneGenerator();
            SetPropertyMap(expression, gen);
        ...
        /// <returns></returns>
        public Hydrator<T> WithAmericanPostalCode<TProperty>(Expression<Func<T, TProperty>> expression,
            int percentageWithPlusFour)
        {
            var gen = (IGenerator<TProperty>) new AmericanPostalCodeGenerator(percentageWithPlusFour);
            SetPropertyMap(expression, gen);
        ...
        {
            var gen = (IGenerator<TProperty>) new AmericanStateGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new UnitedKingdomCountyGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new UnitedKingdomPostCodeGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new CcvGenerator(ccvtype);
            SetPropertyMap(expression, gen);
        ...
        {
            var gen = (IGenerator<TProperty>) new CompanyNameGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new CreditCardNumberGenerator(length);
            SetPropertyMap(expression, gen);
        ...
        {
            var gen = (IGenerator<TProperty>) new CreditCardTypeGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new GenderGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new LastNameGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new PasswordGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new PasswordGenerator(length);
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new TextGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new TextGenerator(length);
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new TrackingNumberGenerator(carrier);
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new WebsiteGenerator();
            SetPropertyMap(expression, gen);
            return this;
        }
        ...
        {
            var gen = (IGenerator<TProperty>) new AlphaNumericGenerator(length);
            SetPropertyMap(expression, gen);
            return this;
        }

        public Hydrator<T> WithCultures<TProperty>(Expression<Func<T, TProperty>> expression,
            Func<CultureInfo, TProperty> propertyGetter)
        {
        ...
        {
            var gen = (IGenerator<TProperty>) ListGenerator<TProperty>.RandomLength();
            SetPropertyMap(expression, gen);
            return this;
        }
